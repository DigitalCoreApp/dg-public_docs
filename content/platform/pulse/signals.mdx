...
A signal is something DigitalCore noticed in your data and thinks you should look at. Every signal can be turned into a [Response](/concepts/response-frame) with one click.
